...
public class BlowFishHandler {
    private static class BlowfishCBC extends BlowfishECB {
        ...
        public void getCBCIV(byte dest[]) {
            BlowFishHandler.longToByteArray(m_lCBCIV, dest, 0);
        }
        ...
        public void setCBCIV(byte newCBCIV[]) {
            m_lCBCIV = BlowFishHandler.byteArrayToLong(newCBCIV, 0);
        }
        ...
        public void encrypt(byte inbuffer[], byte outbuffer[]) {
            ...
            for (int nI = 0; nI < nLen; nI += 8) {
                long lTemp = BlowFishHandler.byteArrayToLong(inbuffer, nI);
                lTemp = encryptBlockCBC(lTemp);
                BlowFishHandler.longToByteArray(lTemp, outbuffer, nI);
            }
        ...
        public void encrypt(byte buffer[]) {
            ...
            for (int nI = 0; nI < nLen; nI += 8) {
                long lTemp = BlowFishHandler.byteArrayToLong(buffer, nI);
                lTemp = encryptBlockCBC(lTemp);
                BlowFishHandler.longToByteArray(lTemp, buffer, nI);
            }
        ...
        public void encrypt(int inbuffer[], int outbuffer[]) {
            ...
            for (int nI = 0; nI < nLen; nI += 2) {
                long lTemp = BlowFishHandler.intArrayToLong(inbuffer, nI);
                lTemp = encryptBlockCBC(lTemp);
                BlowFishHandler.longToIntArray(lTemp, outbuffer, nI);
            }
        ...
        public void encrypt(int buffer[]) {
            int nLen = buffer.length;
            for (int nI = 0; nI < nLen; nI += 2) {
                long lTemp = BlowFishHandler.intArrayToLong(buffer, nI);
                lTemp = encryptBlockCBC(lTemp);
                BlowFishHandler.longToIntArray(lTemp, buffer, nI);
            }
    ...
    private static class BlowfishECB {
        ...
        protected long encryptBlock(long lPlainBlock) {
            int nHi = BlowFishHandler.longHi32(lPlainBlock);
            int nLo = BlowFishHandler.longLo32(lPlainBlock);
            int sbox1[] = m_sbox1;
            int sbox2[] = m_sbox2;
            int sbox3[] = m_sbox3;
            int sbox4[] = m_sbox4;
            ...
            return BlowFishHandler.makeLong(nHi, nLo ^ pbox[17]);
        }

        protected long decryptBlock(long lCipherBlock) {
            int nHi = BlowFishHandler.longHi32(lCipherBlock);
            int nLo = BlowFishHandler.longLo32(lCipherBlock);
            nHi ^= m_pbox[17];
            ...
            return BlowFishHandler.makeLong(nHi, nLo ^ m_pbox[0]);
        }
    ...
    public BlowFishHandler(String password) {
